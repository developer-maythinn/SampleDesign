...
const items = [
    ...
    { 
        ...
        direction: "right",
        logo: "https://venuslab.co/images/case-study/apn-logo.png",
        title: "MyanmarAPN",
        ...
        image: "https://venuslab.co/images/case-study/mmapn.png",
...
export function Product(props) {
  ...
  return (
    <>
      <section className={`section ${item.direction}`} style={{ background: item.backgroundColor }}>
